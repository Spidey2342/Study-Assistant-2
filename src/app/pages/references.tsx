...
const videos = [
  ...
  },
 {
...

  {
   ...
   {
    id: 27,
    title: 'Mathematical Induction Practice Problems',
    description: 'Mathematical Induction Practice Problems',
    thumbnail: getYouTubeThumbnail('https://youtu.be/tHNVX3e9zd0?si=0hARC7zKmg3JCkDf'),
    duration: '18:07',
    channel: 'The Organic Chemistry Tutor',
    url: 'https://youtu.be/tHNVX3e9zd0?si=0hARC7zKmg3JCkDf',
    category: 'Basic Electronics',
  },
   {
    id: 28,
    title: 'Intro to Computer Networks - Crash Course',
    description: 'Intro to Computer Networks - Crash Course',
    thumbnail: getYouTubeThumbnail('https://youtu.be/WO6P92v61y4?si=5xZR9ou8zFYgRy7g'),
    duration: '08:07',
    channel: 'freeCodeCamp',
    url: 'https://youtu.be/WO6P92v61y4?si=5xZR9ou8zFYgRy7g',
    category: 'Basic Electronics',
  },
   {
    id: 29,
    title: 'Introduction to Programming and Computer Science - Full Course',
    description: 'Introduction to Programming and Computer Science - Full Course',
    thumbnail: getYouTubeThumbnail('https://youtu.be/zOjov-2OZ0E?si=9tzJr66D6e_XIc9B'),
    duration: '01:59:08',
    channel: 'freeCodeCamp',
    url: 'https://youtu.be/zOjov-2OZ0E?si=9tzJr66D6e_XIc9B',
    category: 'Basic Electronics',
  },
  {
    id: 30,
    title: 'Avoir (to have) in 5 Main French Tenses',
    description: 'Avoir (to have) in 5 Main French Tenses',
    thumbnail: getYouTubeThumbnail('https://youtu.be/f6ADfd0HTLo?si=mYaRYTsYrRBgzH87'),
    duration: '07:55',
    channel: 'Learn french with Alexa',
    url: 'https://youtu.be/f6ADfd0HTLo?si=mYaRYTsYrRBgzH87',
    category: 'Basic Electronics',
  },
   {
    id: 31,
    title: 'Aller (to go) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    description: 'Aller (to go) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    thumbnail: getYouTubeThumbnail('https://youtu.be/Ru9pCQDV1eE?si=bFjxUQqLTHJO5vj_'),
    duration: '06:50',
    channel: 'Learn french with Alexa',
    url: 'https://youtu.be/Ru9pCQDV1eE?si=bFjxUQqLTHJO5vj_',
    category: 'Basic Electronics',
  },
     {
    id: 32,
    title: 'Être (to be) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    description: 'Être (to be) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    thumbnail: getYouTubeThumbnail('https://youtu.be/CbxrZMePugU?si=jgccrJsqwgN2Ro0s'),
    duration: '05:38',
    channel: 'Learn french with Alexa',
    url: 'https://youtu.be/CbxrZMePugU?si=jgccrJsqwgN2Ro0s',
    category: 'Basic Electronics',
  },
   {
    id: 33,
    title: 'Avoir (to have) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    description: 'Avoir (to have) — Present Tense (French verbs conjugated by Learn French With Alexa)',
    thumbnail: getYouTubeThumbnail('https://youtu.be/sA82J16mNfU?si=FOrCk2nTayt8Hgpg'),
    duration: '04:25',
    channel: 'Learn french with Alexa',
    url: 'https://youtu.be/sA82J16mNfU?si=FOrCk2nTayt8Hgpg',
    category: 'Basic Electronics',
  },
];
